...
describe Formatter do
  it "should list all the formatters" do
    Formatter.formatters.sort.should eql(%w(markdown textile html haml).sort)
  end
  it "should format Markdown" do
    Formatter.format(:markdown, "*Hello*").should eql("<p><em>Hello</em></p>")
  end
  it "should format HAML" do
    Formatter.format(:haml, "%strong Hello").should eql("<strong>Hello</strong>\n")
  end
